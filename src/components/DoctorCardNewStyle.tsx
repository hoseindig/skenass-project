    ...
    <div className="bg-white border border-gray-200 hover:border-gray-300 transition-colors" style={{ borderRadius: ".375rem" }}>
      <div className="p-4 flex items-start gap-3">
        <div className="relative">
          ...
          <div
            className={`absolute -top-1 -left-1 rounded-full p-1 cursor-pointer transition-colors ${isFav ? "bg-teal-500 hover:bg-teal-600" : "bg-gray-300 hover:bg-gray-400"
              }`}
        ...
        <div className="flex-1">
          <h3 className="text-base font-bold text-gray-900 mb-0.5">{doctor.full_name}</h3>
